...
corners, sample the loaded track's center/right/left boundaries for browser
...
redline, and per-wheel spin/slip scalars. The browser harness now draws E-Track
